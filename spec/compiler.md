...
`TOPAL-COMPILER-LEXICAL-RETURN-ENUM-FALLBACK-DECISION-ACTIONS-001`, a
...
`TOPAL-COMPILER-LEXICAL-RETURN-ORDERED-COMPARISON-DECISION-ACTIONS-001`, and
final-fallback declared-Enum decisions whose every action returns as admitted by
`TOPAL-COMPILER-LEXICAL-RETURN-ENUM-FALLBACK-DECISION-ACTIONS-001`, this rule
...
`TOPAL-COMPILER-LEXICAL-RETURN-ORDERED-COMPARISON-DECISION-ACTIONS-001`, and
final-fallback declared-Enum decisions whose every action returns as admitted by
`TOPAL-COMPILER-LEXICAL-RETURN-ENUM-FALLBACK-DECISION-ACTIONS-001`, other
...
`TOPAL-COMPILER-LEXICAL-RETURN-ORDERED-COMPARISON-DECISION-ACTIONS-001`, and
`TOPAL-COMPILER-LEXICAL-RETURN-ENUM-FALLBACK-DECISION-ACTIONS-001`, callbacks,
...
`TOPAL-COMPILER-LEXICAL-RETURN-COMPARISON-VALUE-DECISION-ACTIONS-001`,
`TOPAL-COMPILER-LEXICAL-RETURN-ORDERED-COMPARISON-DECISION-ACTIONS-001`, and
`TOPAL-COMPILER-LEXICAL-RETURN-ENUM-FALLBACK-DECISION-ACTIONS-001`, a nested
...
outside `TOPAL-COMPILER-LEXICAL-RETURN-ENUM-FALLBACK-DECISION-ACTIONS-001`, a
...
table, another decision classifier, any normally completing action, a nested
action expression, callbacks, generators, and cleanup-bearing actions SHALL
remain fail-closed until their separate exit-edge and cleanup lowering is
admitted. This rule SHALL introduce no runtime control-flow object, allocation,
indirect call, unwind edge, foreign dependency, C/C++ standard library, public
ABI, or native-ABI revision.
