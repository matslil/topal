...
fn executes_the_standard_library_example_from_its_shared_module_tree() {
    ...
    assert!(stdout.contains("((Int, Rational, (Int, Int), (Int, Int), Int, Int, Int, Rational, Optional Int, Boolean, Optional (Int, String), Rational, Int, Boolean, Rational, (Int, Int), Range Int, String, String))"));
}
