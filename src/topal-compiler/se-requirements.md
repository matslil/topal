...
single machine return. Constructors, packaged or nested call arguments,
overloaded or indirect calls, decisions, callbacks, generators, and scopes with
cleanup obligations shall remain fail-closed.
