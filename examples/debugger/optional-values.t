...
describe is fn (candidate : Optional Int) -> String
  candidate
    ...
    None then "absent"
(Some 42, Some "present", None Int, None String, missing, preserve (Some 7), preserve (None Int), absent (), describe (Some 7), describe missing, (None Int) = (None Int), (Some 7) = (Some 7), (Some 7) = (None Int), (Some 7) != (Some 8))
