...
- Typed [environments](environments.md) provide immutable, downward-propagating
  diagnostic operations, execution context, and service capabilities without
  process-global variables or shared mutable application state.
