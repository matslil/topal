...
unique-strings is fn (values : List String) -> List String
  values fold (Empty String) { selected, value } append-unique (selected, value)
...
pub reachable is fn (
  ...
  nodes fold (unique-strings starts) { reached, node } propagate-once (reached, edges)
...
### Return a minimum-weight directed path and its exact total weight; reject negative edge weights.
