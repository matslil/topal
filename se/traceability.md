...
| `TOPAL-INTP-SUBSET-026` | `TOPAL-SYN-STRING-001`, `TOPAL-TYPE-CALL-001`, `TOPAL-STRING-CONCAT-001` | unit tests in `topal-language`; `src/topal-interpreter/tests/cli.rs`; `examples/interpreter/strings-and-products.t` | `topal-syntax`, `topal-language`, `topal-interpreter`, `topal-lsp`, `topal-debugger` |
