...
**Correction audit:** the initial Phase 10 declaration was accepted as an
implementation baseline, then independently audited and found incomplete. The
core is not complete until both the specification ledger and
[`core-language-corrections.md`](core-language-corrections.md) contain no
planned row. Acceptance tests enforce this condition before a completion record
may be restored.
