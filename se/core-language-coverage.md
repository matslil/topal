...
| `spec/functions.md` | 32 | 4 | `topal-language` execution | runtime | complete |
...
| `spec/standard-library.md` | 4 | 9 | shared library loader and cross-tool conformance suites | static, runtime, artifact | complete |
