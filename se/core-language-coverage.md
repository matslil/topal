...
| `spec/effects.md` | 3 | 6 | `topal-semantics`, shared source tools | static, runtime | planned |
| `spec/resources.md` | 3 | 6 | `topal-semantics`, shared execution tools | static, runtime | planned |
