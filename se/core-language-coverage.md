...
| `spec/containers.md` | 50 | 3 | `topal-language` value domains | runtime | complete |
...
| `spec/standard-library.md` | 16 | 9 | shared library loader and cross-tool conformance suites | static, runtime, artifact | complete |
