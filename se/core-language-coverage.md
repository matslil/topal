...
| `spec/strings.md` | 25 | 3 | `topal-source`, `topal-language` | static, runtime | complete |
| `spec/containers.md` | 49 | 3 | `topal-language` value domains | runtime | complete |
...
| `spec/data-transfer-packages.md` | 5 | 10 | extended packages and shared host boundary | static, runtime, platform | planned |
| `spec/data-transfers.md` | 21 | 11 | `topal-transfer` and ordinary transfer package | static, runtime | planned |
