...
| `spec/containers.md` | 51 | 3 | `topal-language` value domains | runtime | complete |
...
| `spec/standard-library.md` | 20 | 9 | shared library loader and cross-tool conformance suites | static, runtime, artifact | complete |
